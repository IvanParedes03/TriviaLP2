    ...
    , preguntas()
{
    ...
    ui->setupUi(this);
    connect(ui->listWidget_listaPreguntas,
            &QListWidget::currentItemChanged,
            this,
            &VentanaListarPreguntas::elementoSeleccionadoPregunta);
}
    ...
    for (const auto &preguntaObjeto : preguntasJson) {
        if (preguntaObjeto.isObject()) {
            ...
            QString itemTexto = QString("Pregunta: %1 \nCategoría: %2 \nID: %3")
                                    .arg(preguntaTexto, categoria, id);
...
void VentanaListarPreguntas::elementoSeleccionadoPregunta(QListWidgetItem *elemActual,
...
void VentanaListarPreguntas::on_pushButton_editarPreguntaSeleccionada_clicked()
{
    ...
    if (!preguntaParaEditar.isEmpty()) {
        VentanaEditarPreguntas *ventanaEditarPreguntas
            = new VentanaEditarPreguntas(preguntaParaEditar, this);
        connect(ventanaEditarPreguntas,
                &VentanaEditarPreguntas::preguntaEditadaGuardada,
                this,
                &VentanaListarPreguntas::cargarListaPreguntas);
