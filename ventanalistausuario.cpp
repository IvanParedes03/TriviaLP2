...
ventanaListaUsuario::ventanaListaUsuario(std::vector<Usuario>& usuarios, QWidget *parent)
    : QDialog(parent), usuariosFromVentanaUsuario(usuarios)
    , ui(new Ui::ventanaListaUsuario)
{
    ...
    connect(ui->botonVolverGestion, &QPushButton::clicked, this, &ventanaListaUsuario::volverGestionUsuario);
    connect(ui->botonListaUsuariosAtras, &QPushButton::clicked, this, &ventanaListaUsuario::anteriorUsuario);
    connect(ui->botonListaUsuariosAdelante, &QPushButton::clicked, this, &ventanaListaUsuario::siguienteUsuario);
    connect(ui->botonEditarUsuario, &QPushButton::clicked, this, &ventanaListaUsuario::abrirVentanaEditarUsuario);
    connect(ui->botonEliminarUsuario, &QPushButton::clicked, this, &ventanaListaUsuario::eliminarUsuario);
}
...
void ventanaListaUsuario::refreshLista(){
    ...
    ui->labelNombreLista->setText(QString::fromStdString(usuariosFromVentanaUsuario[iteradorUsuario].getNombre()));
    ui->labelAliasLista->setText(QString::fromStdString(usuariosFromVentanaUsuario[iteradorUsuario].getAlias()));
}
...
void ventanaListaUsuario::abrirVentanaEditarUsuario(){
    VentanaEditarUsuario *ventanaEditar= new VentanaEditarUsuario(usuariosFromVentanaUsuario, iteradorUsuario);
