...
public:
    ...
    void setupUi(QDialog *ventanaListaUsuario)
    {
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, labelNombreLista);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, labelAliasLista);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->setItem(2, QFormLayout::ItemRole::LabelRole, verticalSpacer);
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, botonEditarUsuario);
