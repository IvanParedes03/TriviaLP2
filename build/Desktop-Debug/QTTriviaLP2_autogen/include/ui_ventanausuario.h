...
public:
    ...
    void setupUi(QDialog *VentanaUsuario)
    {
        ...
        formLayoutWidget->setGeometry(QRect(0, 90, 701, 509));
        ...
        titleGestionLayout->setWidget(0, QFormLayout::LabelRole, label_2);
        ...
        titleGestionLayout->setWidget(0, QFormLayout::FieldRole, nombreUsuarioInput);

        label = new QLabel(formLayoutWidget);
        label->setObjectName("label");
        label->setFont(font1);

        titleGestionLayout->setWidget(1, QFormLayout::LabelRole, label);
        ...
        titleGestionLayout->setWidget(1, QFormLayout::FieldRole, aliasUsuarioInput);

        horizontalLayoutWidget = new QWidget(VentanaUsuario);
        horizontalLayoutWidget->setObjectName("horizontalLayoutWidget");
        horizontalLayoutWidget->setGeometry(QRect(0, 370, 701, 131));
        ...
        labelFeedbackUsuario = new QLabel(horizontalLayoutWidget);
        labelFeedbackUsuario->setObjectName("labelFeedbackUsuario");
        labelFeedbackUsuario->setAlignment(Qt::AlignmentFlag::AlignCenter);

        formGestionLayout->addWidget(labelFeedbackUsuario);
    ...
    void retranslateUi(QDialog *VentanaUsuario)
    {
        ...
        labelFeedbackUsuario->setText(QString());
